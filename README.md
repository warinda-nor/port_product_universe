...
- แถวที่ `Universe` เป็นค่าว่าง/ไม่ใช่ 4 tier มาตรฐาน จะถูกจัดเป็น `UNCLASSIFIED` — รวมอยู่ในตาราง Sales by Universe - Detail, stacked bar (Product Group/Brand) และโดนัทชาร์ต Sales by Universe ด้วย แต่กริด "Universe Performance" กับตาราง "Top Products by Universe" ไม่รวม UNCLASSIFIED (แสดงแค่ 4 tier มาตรฐาน)
